import { _ as _defineProperty, a as _objectWithoutPropertiesLoose, b as _toPropertyKey, c as _setPrototypeOf, d as _typeof } from "./Layout-22ba3e0a.js";
import { r as reactExports, k as keyframes, m as jsx, _ as _extends, n as reactDomExports, p as css$2 } from "./app-273ef8d8.js";
...
function S(t) {
  const e = F(t);
  return g(e) ? e.ownerDocument.body : s(e) && a(e) ? e : S(e);
}
function W(t, e) {
  var o2;
  void 0 === e && (e = []);
  const i = S(t), r2 = i === (null == (o2 = t.ownerDocument) ? void 0 : o2.body), l2 = n(i);
  return r2 ? e.concat(l2, l2.visualViewport || [], a(i) ? i : []) : e.concat(i, W(i));
}
function z(t, e, n2, o2) {
  void 0 === o2 && (o2 = {});
  const { ancestorScroll: i = true, ancestorResize: r2 = true, elementResize: l2 = true, animationFrame: c2 = false } = o2, s2 = i || r2 ? [...f(t) ? W(t) : t.contextElement ? W(t.contextElement) : [], ...W(e)] : [];
  s2.forEach((t2) => {
    const e2 = !f(t2) && t2.toString().includes("V");
    !i || c2 && !e2 || t2.addEventListener("scroll", n2, { passive: true }), r2 && t2.addEventListener("resize", n2);
  });
  let u2, a2 = null;
  l2 && (a2 = new ResizeObserver(() => {
    n2();
  }), f(t) && !c2 && a2.observe(t), f(t) || !t.contextElement || c2 || a2.observe(t.contextElement), a2.observe(e));
  let d = c2 ? E(t) : null;
  return c2 && function e2() {
    const o3 = E(t);
    !d || o3.x === d.x && o3.y === d.y && o3.width === d.width && o3.height === d.height || n2();
    d = o3, u2 = requestAnimationFrame(e2);
  }(), n2(), () => {
    var t2;
    s2.forEach((t3) => {
      i && t3.removeEventListener("scroll", n2), r2 && t3.removeEventListener("resize", n2);
